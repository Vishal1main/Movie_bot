...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tmr624062:OJ3EwrOaDYaDSvnh@cluster0.kal0p.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

DATABASE_NAME = environ.get('DATABASE_NAME', "The")
